...
async function startAppDevServer(args, context) {
  ...
  try {
    ...
    await devAction.startDevServer({
      ...
      skipStartLog: !0,
      isApp: !0
    }), spinner.succeed(), output.print(`Dev server started on port ${config.httpPort}`), output.print("View your app in the Sanity dashboard here:"), output.print(chalk__default.default.blue(chalk__default.default.underline(await devAction.getCoreAppURL({
      organizationId,
